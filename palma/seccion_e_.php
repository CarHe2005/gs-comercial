...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/E/E1.jpeg" alt="" class="img-fluid">
...
<!--fin-->
  ...
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
      <img src="vista/img/E/E2.jpeg" alt="" class="img-fluid" >
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/E/E3.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5031;
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/E/E4.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5032;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/E/E5.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5033;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
