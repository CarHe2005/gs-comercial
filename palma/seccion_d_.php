...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/D/D1.jpeg" alt="" class="img-fluid">
...
<!--fin-->
  ...
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
      <img src="vista/img/D/D2.jpeg" alt="" class="img-fluid" >
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/D/D3.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5026;
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/D/D4.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5027;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/D/D5.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5028;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
