...
// Buscamos verificar si se envio de forma correcta
// Verificar si se enviaron los parámetros de estado y ubicación
$estado = 0;
$ubicacion = 0;
...
// Consulta SQL para obtener datos específicos basados en la ubicación seleccionada y ID_PDV igual a 3
$sql1 = $conexion->prepare("SELECT secciones.*, estado.NOM_EST, grupos.NOM_GRUP, puntos_venta.NOM_PDV
                         ...
                         WHERE (? = 0 OR secciones.ID_EST = ?) AND (? = 0 OR secciones.ID_UBI = ?)  AND puntos_venta.ID_PDV = 5
...
<head>
    ...
    <title>Información Balmoral</title>
...
<form action="" method="get">
  ...
  <option value="0" <?php if ($ubicacion == 0) echo 'selected'; ?>>Todas las Secciones</option>
    <option value="1" <?php if ($ubicacion == 1) echo 'selected'; ?>>Sección Externa</option>
    ...
    <option value="10" <?php if ($ubicacion == 10) echo 'selected'; ?>>Sección I</option>
    <option value="11" <?php if ($ubicacion == 11) echo 'selected'; ?>>Sección J</option>
    <option value="12" <?php if ($ubicacion == 12) echo 'selected'; ?>>Sección K</option>
    <option value="13" <?php if ($ubicacion == 13) echo 'selected'; ?>>Sección L</option>
    <option value="14" <?php if ($ubicacion == 14) echo 'selected'; ?>>Sección M</option>
    <option value="15" <?php if ($ubicacion == 15) echo 'selected'; ?>>Sección N</option>
    <option value="16" <?php if ($ubicacion == 16) echo 'selected'; ?>>Sección Ñ</option>
