...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/EXTERNA/A0.jpeg" alt="" class="img-fluid">
  ...
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
      <img src="vista/img/EXTERNA/EX2.jpeg" alt="" class="img-fluid" >
...
<!--3-->
  ...
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
      <img src="vista/img/EXTERNA/EX3.jpeg" alt="" class="img-fluid" >
      <!--Obtención de datos de manera manual-->
      <?php
      $id_sec2 = 5003;
