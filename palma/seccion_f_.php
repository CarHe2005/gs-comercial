...
if (isset($_SESSION['rol']) && $_SESSION['rol'] == 1) {
    ...
    $botonEditar = '<a href="crudpalma.php" class="btn boton-largo btn-success">Editar</a>';
} else {
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F1.jpeg" alt="" class="img-fluid">
...
<!--fin-->
  ...
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
      <img src="vista/img/F/F2.jpeg" alt="" class="img-fluid" >
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/FE_F5.JPEG" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5036;
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F6.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5039;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F7.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5040;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F8.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5041;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F9.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5042;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F10.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5043;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F11.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5044;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F12.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5045;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F13.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5046;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F14.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5047;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F15.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5048;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F16.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5168;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F17.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5169;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F18.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5170;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F19.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5171;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F20.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5172;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
...
<div class="columns">
  <div class="container-izquierdo">
    <!--img seccion 1-->
    <div class="img1">
    <img src="vista/img/F/F21.jpeg" alt="" class="img-fluid">
    <!-- obteción de datos manual, recordar que depende del id se visualiza la info-->
  <?php
  $id_sec2 = 5173;
  $datosSeccion = obtenerDatosSeccion($id_sec2);
